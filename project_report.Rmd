...
But, when focusing specially on highlighted objects (essentially, popular artworks), the rankings change, with _The American Wing_ being the department with the most objects. Close behind _The American Wing_, _Asian Art_ comes in second with the most highlighted objects.
...
As we explore each department and the objects they hold, we find that _Drawings and Prints_ mostly contains drawings and prints (no surprise there). In _Drawings and Prints_, prints outnumber other objects by more than 300%. _Photographs_ also mainly contains photographs (again, unsurprisingly, and with photographs outnumbering other objects in the department 3 to 1). The most common object is a piece in both _Asian Art_ and _European Sculpture and Decorative Arts_.
...
The only department with only two types of objects is _European Paintings_, as it contains only paintings and drawings. Finally, let's discuss a collection close to us at the CUMC campus: [The Cloisters](https://www.metmuseum.org/visit/plan-your-visit/met-cloisters). The Cloisters collection largely consists of panel, Pilgrim's badge, and capital-type works. Most of the art displayed at _The Cloisters_ is in fact part of _The Medieval Art_ Department.
