...
The Met's data was as overwhelming as The Met itself, we had to narrow down our focus. Although the database contains **a lot** of data, it also lacked data in certain variables. We decided to work with the variables with the most complete data and developed the following questions:
